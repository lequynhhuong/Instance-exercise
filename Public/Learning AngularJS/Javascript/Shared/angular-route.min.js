...
(function(p, d, C) {
        ...
        function x() {
          ...
          if (d.isDefined(b && b.$template)) {
            ...
            m = y(b, function(b) {
              g.enter(b, null, m || c).
                  then(
                      function() {!d.isDefined(t) || t && !a.$eval(t) || h();});
              z();
            });
            l = f.scope = b;
  ...
  function A(d, h, g) {
    return {
      ...
      link: function(a, c) {
        ...
        c.html(f.$template);
        var y = d(c.contents());
        b.controller && (f.$scope = a, f = h(b.controller, f), b.controllerAs &&
        (a[b.controllerAs] = f), c.data('$ngControllerController',
            f), c.children().data('$ngControllerController', f));
        y(a);
      },
    };
  }
  ...
  p = d.module('ngRoute', ['ng']).provider('$route', function() {
    ...
    function h(a, d) {
      var b = d.caseInsensitiveMatch, f = {originalPath: a, regexp: a},
          g = f.keys = [];
      a = a.replace(/([().])/g, '\\$1').
    ...
    this.$get = [
      ...
      function(a, c, b, f, h, p, x) {
        function l(b) {
          var e = s.current;
          (v = (n = k()) && e && n.$$route === e.$$route &&
              d.equals(n.pathParams, e.pathParams) && !n.reloadOnSearch &&
              !w) || !e && !n ||
          a.$broadcast('$routeChangeStart', n, e).defaultPrevented && b &&
          b.preventDefault();
        }

        function m() {
          var u = s.current, e = n;
          if (v) u.params = e.params, d.copy(u.params, b), a.$broadcast(
              '$routeUpdate', u); else if (e || u) w = !1, (s.current = e) &&
          e.redirectTo &&
          (d.isString(e.redirectTo) ? c.path(t(e.redirectTo, e.params)).
              search(e.params).
              replace() : c.url(
              e.redirectTo(e.pathParams, c.path(), c.search())).
              replace()), f.when(e).
              then(function() {
                if (e) {
                  var a =
                  ...
                  d.forEach(a, function(b, e) {
                    a[e] = d.isString(b) ? h.get(b) : h.invoke(b, null, null,
                        e);
                  });
                  d.isDefined(b = e.template)
                      ? d.isFunction(b) && (b = b(e.params))
                      : d.isDefined(c = e.templateUrl) && (d.isFunction(c) &&
                  (c = c(e.params)), c = x.getTrustedResourceUrl(
                      c), d.isDefined(c) &&
              ...
              then(function(c) {
                e == s.current &&
                (e && (e.locals = c, d.copy(e.params, b)), a.$broadcast(
                    '$routeChangeSuccess', e, u));
              }, function(b) {
          ...
          updateParams: function(a) {
            if (this.current && this.current.$$route) {
              ...
              d.forEach(Object.keys(a),
                  function(c) {f.current.pathParams[c] || (b[c] = a[c]);});
