  ...
  angular.mock.$LogProvider = function() {
    ...
    this.$get = function() {
      ...
      $log.assertEmpty = function() {
        var errors = [];
        angular.forEach(['error', 'warn', 'info', 'log', 'debug'],
            function(logLevel) {
              angular.forEach($log[logLevel].logs, function(log) {
                angular.forEach(log, function(logItem) {
                  errors.push('MOCK $log (' + logLevel + '): ' +
                      String(logItem) + '\n' +
                      (logItem.stack || ''));
                });
              });
...
//make "tzDateInstance instanceof Date" return true
  ...
  angular.mock.animate = angular.module('ngAnimateMock', ['ng']).config([
    '$provide', function($provide) {
      ...
      $provide.decorator('$animate', [
        '$delegate', '$$asyncCallback', '$timeout', '$browser',
  ...
  angular.mock.dump = function(object) {
    ...
    function serialize(object) {
      ...
      if (angular.isElement(object)) {
        ...
        if (angular.isFunction(object.$eval) &&
  ...
  function createHttpBackendMock($rootScope, $timeout, $delegate, $browser) {
    ...
    function $httpBackend(
      ...
      function prettyPrint(data) {
        return (angular.isString(data) || angular.isFunction(data) ||
      ...
      function wrapResponse(wrapped) {
        if (!$browser && timeout) {
          timeout.then ? timeout.then(handleTimeout) : $timeout(handleTimeout,
              timeout);
        }
        ...
        function handleResponse() {
          ...
          callback(copy(response[0]), copy(response[1]),
   ...
   *    | function(function(method, url, data, headers)}`
    ...
    $httpBackend.flush = function(count, digest) {
      ...
      if (angular.isDefined(count) && count !== null) {
        while (count--) {
          if (!responses.length) throw new Error(
  ...
  function MockHttpExpectation(method, url, data, headers) {
    ...
    this.matchData = function(d) {
      ...
      if (data && !angular.isString(data)) {
        return angular.equals(angular.fromJson(angular.toJson(data)),
            angular.fromJson(d));
      }
      return data == d;
    };
  ...
  function MockXhr() {
    ...
    this.getResponseHeader = function(name) {
      ...
      angular.forEach(this.$$respHeaders, function(headerVal, headerName) {
        if (!header &&
            angular.lowercase(headerName) == name) header = headerVal;
      });
      return header;
    };
  ...
  angular.module('ngMock', ['ng']).provider({
    ...
    '$provide', function($provide) {
      ...
      $provide.decorator('$$asyncCallback',
          angular.mock.$AsyncCallbackDecorator);
